  ...
  return (
    <span className={cn("group/tt relative inline-flex", className)}>
      ...
      <span
        role="tooltip"
        className={cn(
          "pointer-events-none absolute left-1/2 z-50 -translate-x-1/2 whitespace-nowrap rounded border border-border bg-elevated px-2 py-1 text-[12px] text-text-secondary opacity-0 shadow-md transition-opacity duration-fast",
